    ...
    const projects = [
      {
        ...
        description: "Complete interior and exterior painting with a modern gray palette",
      ...
      },
      {
        ...
        description: "Historical property restoration with period-accurate colors",
        image: "/building.webp",
        duration: "6 weeks",
        status: "Completed"
      },
      {
        ...
        description: "Multi-floor commercial painting project with custom branding",
        image: "/coperate.webp",
        duration: "4 weeks",
        status: "Completed"
      }
        ...
        <div className="relative h-96">
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">Expert Painting Services</h1>
              <p className="text-xl max-w-2xl">Transform your space with our premium painting services</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 mb-6">
                ...
                for both residential and commercial properties. Our team of expert painters combines
                technical expertise with artistic vision to transform any space.
              </p>
              
              <h3 className="text-2xl font-bold mb-4">Our Painting Services Include:</h3>
